...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   light_n_shading_operations.c                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: avarghes <avarghes@student.42berlin.de>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/18 09:42:04 by avarghes          #+#    #+#             */
/*   Updated: 2025/02/18 11:56:00 by avarghes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	normal_at(t_sphere *sphere, t_point world_point)
{
	...
	inv_transpose = transpose_matrix(inv_transform);
